    ...
    <div className="max-w-full text-center m-auto px-6 md:px-32">
          ...
          <div className="w-full bg-white/10 rounded-lg p-4 my-4 hover:border hover:border-cyan-400 hover:shadow-md hover:shadow-cyan-400 transition-all duration-300 ">
                ...
                <h1 className="text-xl font-semibold flex items-center gap-2">
                  ...
                  Diploma in Computer Science and Engineering</h1>
                <a href="https://gpmkheri.com/" target='_blank'><p className="text-gray-400 my-2 flex items-center space-x-2 ml-6 text-lg"><RiAwardFill/>Government Polytechnic Mohammadi-Kheri <i>(2022-25)</i> <MdOutlineLocationOn/> Lakhimpur,Uttar Pradesh.</p></a>
                <p className="text-gray-400 ml-6">Specialized in Software Engineering with focus on web development, database systems, and software architecture. Graduated with honors..</p>
          ...
          <div className="w-full bg-white/10 rounded-lg p-4 my-4 hover:border hover:border-cyan-400 hover:shadow-md hover:shadow-cyan-400 transition-all duration-300 ">
                ...
                <h1 className="text-xl font-semibold flex items-center gap-2">
                  <FaGraduationCap className='text-cyan-400 text-2xl'/>
                  XII & X Standard</h1>
                <p className="text-gray-400 my-2 flex items-center space-x-2 ml-6 text-lg"><RiAwardFill/>Janta Inter College Kalyanpur Sitapur <i>(2020-22)</i> <MdOutlineLocationOn/> Sitapur,Uttar Pradesh.</p>
                <p className="text-gray-400 ml-6">Completed Higher Secondary Education with Science stream, focusing on Physics, Chemistry, and Mathematics, with a strong academic record and active participation in technical and analytical problem-solving activities.</p>
