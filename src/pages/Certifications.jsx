  ...
  return (
    ...
    <div className="max-w-full text-center m-auto px-6 md:px-32">
            ...
            <p className="my-6 text-lg text-gray-400">
              My academic journey and professional certifications that shaped my expertise in full-stack development
            </p>
          </div>
          ...
          <div className="w-full bg-white/10 rounded-lg p-4 my-4 hover:border hover:border-cyan-400 hover:shadow-md hover:shadow-cyan-400 transition-all duration-300 ">
                ...
                <h1 className="text-xl font-semibold flex items-center gap-2">
                  ...
                  ASP.NET Certificates</h1>
                <a href="https://apinfotech.org/" target='_blank'><p className="text-gray-400 my-2 flex items-center space-x-2 ml-6 text-lg"><RiAwardFill/>Arcane Programming infotech pvt. ltd. <i>(2025)</i> <MdOutlineLocationOn/> Lucknow,Uttar Pradesh.</p></a>
                <p className="text-gray-400 ml-6">Advanced certification in ASP.NET Core development, covering MVC, Web APIs, Entity Framework, and cloud deployment.</p>
          ...
          <div className="w-full bg-white/10 rounded-lg p-4 my-4 hover:border hover:border-cyan-400 hover:shadow-md hover:shadow-cyan-400 transition-all duration-300 ">
                ...
                <h1 className="text-xl font-semibold flex items-center gap-2">
                  <FaGraduationCap className='text-cyan-400 text-2xl'/>
                  Summer Internship <i>(45 Days)</i> 2024</h1>
                <a href="https://apinfotech.org/" target='_blank'><p className="text-gray-400 my-2 flex items-center space-x-2 ml-6 text-lg"><RiAwardFill/>Arcane Programming infotech pvt. ltd. <i>(2024)</i> <MdOutlineLocationOn/> Lucknow,Uttar Pradesh.</p></a>
                <p className="text-gray-400 ml-6">Completed a 45-day summer internship, gaining practical exposure to real-world projects, enhancing technical skills, and applying theoretical knowledge to industry-relevant solutions.</p>
          ...
          <div className="w-full bg-white/10 rounded-lg p-4 my-4 hover:border hover:border-cyan-400 hover:shadow-md hover:shadow-cyan-400 transition-all duration-300 ">
                ...
                <h1 className="text-xl font-semibold flex items-center gap-2">
                  <FaGraduationCap className='text-cyan-400 text-2xl'/>
                  Summer Internship <i>(45 Days)</i> 2023</h1>
                <a href="https://apinfotech.org/" target='_blank'><p className="text-gray-400 my-2 flex items-center space-x-2 ml-6 text-lg"><RiAwardFill/>Arcane Programming infotech pvt. ltd. <i>(2023)</i> <MdOutlineLocationOn/> Lucknow,Uttar Pradesh.</p></a>
                <p className="text-gray-400 ml-6">Completed a 45-day summer internship, gaining practical exposure to real-world projects, enhancing technical skills, and applying theoretical knowledge to industry-relevant solutions.</p>
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-10 mt-8 ">
            <div className='h-[200px] flex flex-col text-center justify-center bg-white/10 rounded-lg hover:border  hover:border-cyan-400 hover:shadow-md hover:shadow-cyan-400 transition-all duration-300 '>
             ...
             <div className='h-[200px] flex flex-col text-center justify-center bg-white/10 rounded-lg hover:border  hover:border-cyan-400 hover:shadow-md hover:shadow-cyan-400 transition-all duration-300 '>
              ...
              <h3 className='text-2xl font-semibold text-gray-400 '>Certificates</h3>
            </div>
             <div className='h-[200px] flex flex-col text-center justify-center bg-white/10 rounded-lg hover:border  hover:border-cyan-400 hover:shadow-md hover:shadow-cyan-400 transition-all duration-300 '>
              <h3 className='text-6xl font-bold text-cyan-400'>3+</h3>
